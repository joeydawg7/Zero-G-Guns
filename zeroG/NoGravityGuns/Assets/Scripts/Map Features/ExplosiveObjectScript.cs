...
public class ExplosiveObjectScript : MonoBehaviour
{
    ...
    private void LightOnFire()
    {
        if (!alreadyBurning /*&& timeToExplode > 0.15f*/)
        {
            ...
            //SoundPooler.Instance.PlaySoundEffect(audioSource.clip);
    ...
    void Explode()
    {
        ...
        explosion.Explode(playerLastHitBy, explosionRadius, explosionPower, damageAtcenter, cameraShakeDuration, 40f, true, false);
