...
public class EndGameScript : MonoBehaviour
{
    ...
    //        //5/2 = 2.5 (3)
    //        if (roundWinner.roundWins >= RoundManager.Instance.roundsToWin)
    //        {
    ...
    PlayerDataScript AddRoundWinToWinner(PlayerScript winner)
    {
        ...
        if (roundManager.playerDatas.Length > 0)
        {
            foreach (PlayerDataScript dataSet in roundManager.playerDatas)
            {
