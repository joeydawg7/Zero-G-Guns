...
public class CameraController : MonoBehaviour
{
    ...
    void LateUpdate()
    {
        ...
        {
            HoldOnFinalBlow(players[0], 1.0f, PlayerScript.DamageType.explosive, new Railgun());
        }
    ...
    IEnumerator DelayOnGameStart()
    {
        ...
        {            
            while(NetworkingRoundManager.Instance.playerDatas.Count > players.Count)
            {
                players.Clear();
    ...
    IEnumerator HoldOnFinalBlow(Transform playerWhoWasHit, float t, PlayerScript.DamageType damageType, Guns gunWhoShotYou)
    {
        ...
        SFXMixer.SetFloat("MasterPitchShift", 0.75f);
        ...
        SFXMixer.SetFloat("MasterPitchShift", 1f);
